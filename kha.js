...
Main.__name__ = true;
Main.main = function() {
	kha_System.start(new kha_SystemOptions(null,768,700,null,null),function(_) {
...
Main.boot = function() {
	...
	kha_System.notifyOnFrames(function(fbs) {
		...
		if(z.window(tmp,0,0,uiWidth,512)) {
			...
			z.row([0.14285714285714285,0.2857142857142857,0.14285714285714285,0.2857142857142857,0.14285714285714285]);
			z.text("");
